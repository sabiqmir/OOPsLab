...
void analyzeTemperatures(double temps[], int size)
{
...
int main()
{
    double temperatures[] = {55, 62, 68, 74, 59, 45, 41, 58, 60, 67, 65, 78, 82, 88, 91, 92, 90, 93, 87, 80, 78, 79, 72, 68, 61, 59};
    int size = sizeof(temperatures) / sizeof(temperatures[0]);
    analyzeTemperatures(temperatures, size);
    std::cout << "\nAverage: " << sumOfArray(temperatures, size) / size;
    return 0;
}
